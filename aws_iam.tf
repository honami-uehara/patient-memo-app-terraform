...
resource "aws_iam_role_policy_attachment" "ecs_instance_role_attach" {
  role = aws_iam_role.ecs_instance_role_for_patient_memo_app.name
  policy_arn = aws_iam_policy.ecs_instance_policy_for_patient_memo_app.arn
}

resource "aws_iam_role" "ecs_task_role_for_patient_memo_app" {
  name               = "ecs-task-role-for-patient-memo-app"
  path               = "/"
